...
function toggleSettings() {
    const gearButton = document.getElementById('linkBtn'); // Get the gear button element
    const togglePart = document.getElementById('togglePart'); // Get the toggle part element
    const aside = document.getElementById('aside'); // Get the aside element
